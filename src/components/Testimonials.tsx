      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <span className="text-white/40 text-sm">מעל 500 ביקורות</span>
          </div>
        </motion.div>
        ...
        >
            ...
            <AnimatePresence mode="popLayout">
              {visible.map((t, i) => (
                <motion.div
                  ...
                  className={`relative bg-zinc-900 border border-white/10 rounded-2xl p-7 shadow-sm transition-colors ${i === 1 ? "md:scale-105 md:border-gold-500/30" : ""}`}
                >
                  <Quote size={28} className="text-gold-500/30 absolute top-6 left-6" />
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-11 h-11 bg-gold-500 rounded-full flex items-center justify-center text-black font-bold text-sm shadow-lg">
                      {t.initials}
                    </div>
                    <div>
          ...
          <div className="flex items-center justify-center gap-4 mt-10">
            <button
              onClick={prev}
              className="w-10 h-10 bg-zinc-900 hover:bg-gold-500 hover:text-black text-white rounded-full flex items-center justify-center transition-colors"
            >
